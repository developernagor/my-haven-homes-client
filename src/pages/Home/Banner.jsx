...
const Banner = () => {
  return (
    <div className="relative bg-cover bg-center h-[500px]" style={{ backgroundImage: "url('https://i.ibb.co.com/tZmLk6S/4031.jpg')" }}>
      ...
      <div className="absolute top-40 left-10 md:left-40 lg:left-60 z-5 text-white text-center px-4 md:px-8">
        <h1 className="text-2xl lg:text-6xl font-bold md:mt-10">Find Your Dream Home</h1>
